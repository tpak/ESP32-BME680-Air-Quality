...
```bash
echo 'bme680,location=test Temp=22.5,TempF=72.5,hPa=1013.25,RH=45.0,VOCOhms=80000,Altitide=100,Vraw=2048,Voltage=3.3' | nc -u -w1 localhost 8089
```
...
Docker on macOS doesn't support UDP broadcast reception. You need to set `INFLUX_HOST` in the firmware to your Mac's IP address:

1. Find your Mac's IP: `ipconfig getifaddr en0`
2. Edit `ESP32-BME680-Air-Quality.ino` and update `INFLUX_HOST`:
   ```cpp
   #define INFLUX_HOST 192, 168, 1, 100  // your Mac's IP
   ```
